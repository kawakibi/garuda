...
$db['default']['hostname'] = 'garudainstance.cknhoxfseolf.ap-southeast-1.rds.amazonaws.com';
$db['default']['username'] = 'garudauser';
$db['default']['password'] = 'garudagaruda';
$db['default']['database'] = 'garuda';
