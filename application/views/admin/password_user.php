				...
				?>
				<h3 id="list"><a href="/admincp">Reset Password User</a></h3>
				<form class="form-horizontal well" method="post" action="/admincp/puser">
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">
								...
								<p class="help-block">Enter Current password for user</p>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								...
								<p class="help-block">New Password for user submitting Document</p>
							</div>
						</div>
